...
public class Blais_v10 extends Robot {
  ...
  double randomNum;
	...
	public void onScannedRobot(ScannedRobotEvent e) {
      if (getOthers() == 16) {
        //KILL PATEL_MISTER
        System.out.println("16 Robots Alive"); //16***
        String intendedTarget = "sample.Fire";
        System.out.println(e.getName() + " -- " + intendedTarget);
        if (e.getName().equals(intendedTarget)) {
          fire(2);
          System.out.println("I shot at my target");
        }
      } else {
        //your shooting code
      }
